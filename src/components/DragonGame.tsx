        ...
        {activeTab === 'home' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Card className="p-4 text-center bg-gradient-to-br from-purple-500/20 to-pink-500/20">
                <Icon name="Target" size={24} className="mx-auto mb-2 text-purple-400" />
                <div className="text-lg font-semibold">{gameState.totalClicks}</div>
